...
console.log("\n");
let tele = readline.question ("Número de telefone/celular:");
console.log("\n");
let email = readline.question ("E-mail:");
console.log("\n");
let nasci = readline.question ("Data de nascimento:");
console.log("\n");
let profi = readline.question ("Profissão:");
console.log("\n");
let endereço = readline.question ("Endereço:");
console.log("\n");
...
console.log ("Data de nascimento:"+nasci);
